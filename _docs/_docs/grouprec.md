...
```python colab={"base_uri": "https://localhost:8080/"} id="z7cZKFdhZwtv" executionInfo={"status": "ok", "timestamp": 1637932811673, "user_tz": -330, "elapsed": 4902, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="010839a5-e2f8-4bc4-8ea1-b78aa47335cf"
