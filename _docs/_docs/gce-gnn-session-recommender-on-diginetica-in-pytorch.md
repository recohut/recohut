...
<!-- #region id="5o-1seUfT9a9" -->
# GCE-GNN Session Recommender on Diginetica in PyTorch
<!-- #endregion -->
...
opt = Args(dataset = 'diginetica')
```

<!-- #region id="lDLp5sxJUCFY" -->
## Dataset
<!-- #endregion -->

```python colab={"base_uri": "https://localhost:8080/"} id="hT2umfIz4gOQ" executionInfo={"status": "ok", "timestamp": 1638277316813, "user_tz": -330, "elapsed": 3160, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="49f06519-d3d3-4f42-92fe-0e6c490cb7a0"
!wget -q --show-progress https://github.com/RecoHut-Datasets/diginetica/raw/v2/all_train_seq.txt
!wget -q --show-progress https://github.com/RecoHut-Datasets/diginetica/raw/v2/train.txt
!wget -q --show-progress https://github.com/RecoHut-Datasets/diginetica/raw/v2/test.txt
```
...
```python colab={"base_uri": "https://localhost:8080/"} id="_S3rQXBz8dsA" executionInfo={"status": "ok", "timestamp": 1638282679736, "user_tz": -330, "elapsed": 3398, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="a07a3d6b-c6f5-4800-c581-b5af62b37a92"
