...
# DCN on Criteo DAC sample dataset in PyTorch
<!-- #endregion -->
...
```python colab={"base_uri": "https://localhost:8080/"} id="ZH69aNy6LmvA" executionInfo={"status": "ok", "timestamp": 1641536386937, "user_tz": -330, "elapsed": 111195, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="b4a53767-f829-4ac0-c989-c623dcf6b3e6"
batch_size = 1024
lr = 1e-2
wd = 1e-3
epoches = 20
