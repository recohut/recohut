...
<!-- #region id="1vi4dOaaDWnX" -->
# Building an RL Agent to complete tasks on the web – Call to Action
<!-- #endregion -->

```python id="fsn3Y3yObopB"
!wget -q --show-progress https://github.com/sparsh-ai/stanza/raw/S990517/webgym.zip
!unzip webgym.zip
```
...
```python colab={"base_uri": "https://localhost:8080/"} id="_ODJjGqoa5ml" executionInfo={"status": "ok", "timestamp": 1638508250464, "user_tz": -330, "elapsed": 2927, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="7e733b76-653e-4851-feb5-7365249d334a"
import argparse
import os
...
```python colab={"base_uri": "https://localhost:8080/"} id="B8YIBwEudcT9" executionInfo={"status": "ok", "timestamp": 1638508250467, "user_tz": -330, "elapsed": 16, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="ccb45c0c-7f2b-438f-871b-2ca7cbfbd30e"
parser = argparse.ArgumentParser(prog="TFRL-Call-To-Action-Agent")
...
```python colab={"base_uri": "https://localhost:8080/"} id="kz9QGt6Wdd6c" executionInfo={"status": "ok", "timestamp": 1638508275045, "user_tz": -330, "elapsed": 22026, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="c4700453-3b88-49ad-d7dd-708333b3704f"
class Actor:
...
%tensorboard --logdir /content/logs/TFRL-Call-To-Action-Agent/MiniWoBClickButtonVisualEnv-v0
```

<!-- #region id="rMbl1AiBtsVm" -->
<!-- #endregion -->
...
```python colab={"base_uri": "https://localhost:8080/"} id="bW0aBsS5tuZs" executionInfo={"status": "ok", "timestamp": 1638508477120, "user_tz": -330, "elapsed": 3532, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="adeb4fdc-a7c8-45fe-8d73-fc29f8c78df6"
