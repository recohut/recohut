...
<!-- #region id="KEZ7VF0_qJDP" -->
# GC-SAN in PyTorch
<!-- #endregion -->

<!-- #region id="WfEZ_9zJSTky" -->
## Imports
<!-- #endregion -->

```python id="pyLgtYzWgk0H"
import math
...
<!-- #region id="w8ZpJv0eSV05" -->
## Model
<!-- #endregion -->

```python id="uYZROGBRg3o2"
