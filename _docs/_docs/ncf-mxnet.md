...
<!-- #region id="6mpREThANWst" -->
The following additional libraries are needed to run this
notebook. Note that running on Colab is experimental, please report a Github
issue if you have any problem.
<!-- #endregion -->

```python id="Dowpmt5tNWs5"
!pip install -U mxnet-cu101==1.7.0
!pip install d2l==0.16.2

```

<!-- #region id="69nVAl7oNWs8" origin_pos=0 -->
...
```python attributes={"classes": [], "id": "", "n": "1"} id="S50aqZsfNWtD" origin_pos=1 tab=["mxnet"]
import random
import mxnet as mx
...
<!-- #region id="pTLo7HlCNWtE" origin_pos=2 -->
...
```python attributes={"classes": [], "id": "", "n": "2"} id="ctFp8WEANWtF" origin_pos=3 tab=["mxnet"]
...
<!-- #region id="-HmDXRUANWtH" origin_pos=4 -->
...
```python attributes={"classes": [], "id": "", "n": "3"} id="eL46hPY5NWtI" origin_pos=5 tab=["mxnet"]
...
<!-- #region id="t-KVXepRNWtJ" origin_pos=6 -->
## Evaluator
...
```python attributes={"classes": [], "id": "", "n": "4"} id="N9_9jIU6NWtK" origin_pos=7 tab=["mxnet"]
#@save
...
<!-- #region id="yZSUbvCdNWtK" origin_pos=8 -->
Then, the overall Hit rate and AUC are calculated as follows.

<!-- #endregion -->

```python attributes={"classes": [], "id": "", "n": "5"} id="uTSrQQQhNWtL" origin_pos=9 tab=["mxnet"]
#@save
...
<!-- #region id="DQCYC0wYNWtM" origin_pos=10 -->
...
```python attributes={"classes": [], "id": "", "n": "6"} id="iTW0y9_1NWtN" origin_pos=11 tab=["mxnet"]
#@save
...
<!-- #region id="fOAJvmYwNWtO" origin_pos=12 -->
...
```python attributes={"classes": [], "id": "", "n": "11"} id="L12Vy0_RNWtO" origin_pos=13 tab=["mxnet"]
batch_size = 1024
...
<!-- #region id="Zb-OoDHENWtP" origin_pos=14 -->
We then create and initialize the model. we use a three-layer MLP with constant hidden size 10.

<!-- #endregion -->

```python attributes={"classes": [], "id": "", "n": "8"} id="Sscq0hCZNWtP" origin_pos=15 tab=["mxnet"]
devices = d2l.try_all_gpus()
net = NeuMF(10, num_users, num_items, nums_hiddens=[10, 10, 10])
net.initialize(ctx=devices, force_reinit=True, init=mx.init.Normal(0.01))
```

<!-- #region id="WH1FrLQ8NWtQ" origin_pos=16 -->
The following code trains the model.

<!-- #endregion -->

```python attributes={"classes": [], "id": "", "n": "12"} id="WpZXUyihNWtQ" origin_pos=17 outputId="0188233f-28c0-49ab-efb6-b245a38b6b18" tab=["mxnet"]
...
<!-- #region id="IraAhvnqNWtS" origin_pos=18 -->
## Summary
...
<!-- #region id="0udhHffPNWtS" origin_pos=19 tab=["mxnet"] -->
