...
```python colab={"base_uri": "https://localhost:8080/"} id="ypuoLu92ixx6" executionInfo={"status": "ok", "timestamp": 1638438523207, "user_tz": -330, "elapsed": 25, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="3f21a3b6-6aad-4738-d198-066ffb268020"
...
<!-- #region id="Og3Z3TTRi_gm" -->
---
<!-- #endregion -->

```python colab={"base_uri": "https://localhost:8080/"} id="uh4ZIHcNi_gp" executionInfo={"status": "ok", "timestamp": 1638438549454, "user_tz": -330, "elapsed": 3838, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="2ef60139-c1dd-40f6-ca5b-9e4e1633e469"
!pip install -q watermark
%reload_ext watermark
%watermark -a "Sparsh A." -m -iv -u -t -d
```

<!-- #region id="T0o4-mvji_gs" -->
---
<!-- #endregion -->

<!-- #region id="XtEYxN3ni_gu" -->
**END**
<!-- #endregion -->
