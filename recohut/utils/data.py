...
__all__ = ['music30', 'music30_sample', 'sample_session', 'DATASETS', 'list_datasets', 'load_dataset']
...
# Cell
sample_session = {
        'url': 'https://github.com/RecoHut-Datasets/sample/raw/main/sample_session.parquet.snappy',
        'type': 'pandas_df',
        'format': 'parquet.snappy',
        'nrows': 5,
        'columns': ['session_id','sequence','ts','user_id'],
        }
