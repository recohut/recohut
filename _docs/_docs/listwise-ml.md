...
# List-wise Movie Recommendations using RL methods on ML-100k dataset
...
```python colab={"base_uri": "https://localhost:8080/"} id="_7FcQ8w7tIVf" executionInfo={"status": "ok", "timestamp": 1639474664126, "user_tz": -330, "elapsed": 621, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="c12c1589-80f8-44ae-bb6c-e0496faee29c"
%tensorflow_version 1.x
```

```python colab={"base_uri": "https://localhost:8080/"} id="6DvK7jdgtLpr" executionInfo={"status": "ok", "timestamp": 1639474668452, "user_tz": -330, "elapsed": 3636, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="d8664ef2-d56e-433c-8b48-172ada05abb0"
import itertools
import pandas as pd
import numpy as np
import random
...
```python colab={"base_uri": "https://localhost:8080/", "height": 206} id="vLfbBCivyTCf" executionInfo={"status": "ok", "timestamp": 1639474725559, "user_tz": -330, "elapsed": 23, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="cee289f6-0559-4429-e3a9-9cd3f7067c3c"
data.head()
```
...
```python colab={"base_uri": "https://localhost:8080/"} id="r8DHUEutvXw-" executionInfo={"status": "ok", "timestamp": 1639475808008, "user_tz": -330, "elapsed": 1077146, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="899656d3-97c3-4794-be7a-c9d99a2d8887"
#collapse-hide
...
```python colab={"base_uri": "https://localhost:8080/"} id="BpUHlaigvZnu" executionInfo={"status": "ok", "timestamp": 1626941654571, "user_tz": -330, "elapsed": 3078350, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "", "userId": "13037694610922482904"}} outputId="528eaaec-2aa9-43e9-c5a2-1b7b9a0bd1d9"
#collapse-hide
...
```python colab={"base_uri": "https://localhost:8080/"} id="8yJVKrr7vduz" executionInfo={"status": "ok", "timestamp": 1626942290389, "user_tz": -330, "elapsed": 263088, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "", "userId": "13037694610922482904"}} outputId="f212f8d8-17db-4602-949f-0490214bfdd5"
...
```python colab={"base_uri": "https://localhost:8080/", "height": 390} id="mAC1k2LnvdsB" executionInfo={"status": "ok", "timestamp": 1626942384281, "user_tz": -330, "elapsed": 3266, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "", "userId": "13037694610922482904"}} outputId="d9a94c9d-205c-4aaa-a6ac-4fc5e0b7dd21"
...
```python colab={"base_uri": "https://localhost:8080/"} id="xBvnWS3tvdnr" executionInfo={"status": "ok", "timestamp": 1626942666535, "user_tz": -330, "elapsed": 124004, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "", "userId": "13037694610922482904"}} outputId="79ecc940-f652-4fdb-f61e-53a43e4fd78d"
...
```python colab={"base_uri": "https://localhost:8080/", "height": 390} id="vvlWDAuLvyJw" executionInfo={"status": "ok", "timestamp": 1626942666538, "user_tz": -330, "elapsed": 8, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "", "userId": "13037694610922482904"}} outputId="5d2db4a1-212f-46cb-936e-080d22420b7f"
plt.figure(figsize=(12,6))
plt.subplot(1, 2, 1)
plt.hist(ratings)
plt.title('Predictions ; Mean = %.4f' % (np.mean(ratings)))
...
<!-- #region id="Hzj-0BBaT5ty" -->
---
<!-- #endregion -->

```python colab={"base_uri": "https://localhost:8080/"} id="Pnr792YuT5t0" executionInfo={"status": "ok", "timestamp": 1639479504487, "user_tz": -330, "elapsed": 4858, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="69ff9dfa-d954-48a9-b5e0-01fd7576f4b0"
!pip install -q watermark
%reload_ext watermark
%watermark -a "Sparsh A." -m -iv -u -t -d
```

<!-- #region id="Aid3hZiLT5t2" -->
---
<!-- #endregion -->

<!-- #region id="oi2SHfdYT5t2" -->
**END**
<!-- #endregion -->
