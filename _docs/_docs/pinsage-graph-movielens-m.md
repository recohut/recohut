...
```python colab={"base_uri": "https://localhost:8080/"} id="m88Ip1w9H7Qn" outputId="1c1227ec-2959-4b8d-821c-589be230eb48"
...
```python colab={"base_uri": "https://localhost:8080/"} id="rL9meK9zIF6x" outputId="e32ac217-2340-4528-e4a7-82207a4ec1d9"
...
```python colab={"base_uri": "https://localhost:8080/", "height": 194} id="CpgWv-wLJAhV" outputId="7a527419-c7fa-49ed-bcce-e42db9c19553"
users.head()
```
...
```python colab={"base_uri": "https://localhost:8080/", "height": 194} id="8eFQ-9yEJJNl" outputId="9af3e74b-fc9c-451a-e963-852668d707ca"
movies.head().iloc[:,:10]
```
...
```python colab={"base_uri": "https://localhost:8080/", "height": 194} id="EHxuDrxsJXPU" outputId="80e99e5e-09e7-4a6f-dd44-0c24aefc3476"
ratings.head()
```
...
```python colab={"base_uri": "https://localhost:8080/"} id="6-78nSGXLCKO" outputId="e9ffbb28-7848-4211-a186-d533b63a61f4"
...
```python colab={"base_uri": "https://localhost:8080/"} id="AmkRQU-rIQZ6" outputId="45eebeaf-c40e-4c56-c260-6f1ce0cd5be6"
...
```python colab={"base_uri": "https://localhost:8080/"} id="3xmC2B58IQWf" outputId="e5281891-163f-4a06-c08d-42861e49ff9f"
%%writefile layers.py
...
```python colab={"base_uri": "https://localhost:8080/"} id="zkv9CEXiNMSR" outputId="40a83e2e-cc88-485b-d697-8b1c569eed29"
...
```python colab={"base_uri": "https://localhost:8080/"} id="_NsYPL1bSseZ" outputId="dc66e775-67e8-4a01-b305-85e1ec5a6bf9"
...
```python colab={"base_uri": "https://localhost:8080/"} id="KSe9dRhQS0t_" outputId="37fa6835-78d9-4c96-8bc4-b76156e4a060"
# Evaluate HIT@10
model.eval()
with torch.no_grad():
