...
# Building an RL Agent to manage emails on the web
<!-- #endregion -->
...
```python colab={"base_uri": "https://localhost:8080/"} id="B8YIBwEudcT9" executionInfo={"status": "ok", "timestamp": 1638511830198, "user_tz": -330, "elapsed": 456, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="85ab874c-ec7a-4cf3-b580-f6171fbb556c"
parser = argparse.ArgumentParser(prog="TFRL-Important-Email-Manager-Agent")
...
```python colab={"base_uri": "https://localhost:8080/"} id="kz9QGt6Wdd6c" executionInfo={"status": "ok", "timestamp": 1638511903468, "user_tz": -330, "elapsed": 68347, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="9c0696c9-cf01-4741-e101-3150d684e1fc"
class Actor:
...
%tensorboard --logdir /content/logs/TFRL-Important-Email-Manager-Agent/MiniWoBEmailInboxImportantVisualEnv-v0
```

<!-- #region id="_Oa3WAo17EQB" -->
<!-- #endregion -->
...
```python colab={"base_uri": "https://localhost:8080/"} id="bW0aBsS5tuZs" executionInfo={"status": "ok", "timestamp": 1638511968196, "user_tz": -330, "elapsed": 3527, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="ea8021bf-7ac4-4d8e-f5f2-87a9970bcf52"
