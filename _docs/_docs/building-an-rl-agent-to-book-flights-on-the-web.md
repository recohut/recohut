...
```python id="Ct-TsEZqajVL" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1638511201579, "user_tz": -330, "elapsed": 23060, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="e94234c0-af8d-4d4a-a02b-27837ba6f732"
...
```python id="_ODJjGqoa5ml" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1638511209054, "user_tz": -330, "elapsed": 2543, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="adb52965-8041-463a-dc5b-f88a0c9725cf"
import argparse
import os
import random
...
```python colab={"base_uri": "https://localhost:8080/"} id="B8YIBwEudcT9" executionInfo={"status": "ok", "timestamp": 1638511265297, "user_tz": -330, "elapsed": 496, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="f026f081-9322-4de1-fc34-eb882929a15c"
...
```python colab={"base_uri": "https://localhost:8080/"} id="kz9QGt6Wdd6c" executionInfo={"status": "ok", "timestamp": 1638511369255, "user_tz": -330, "elapsed": 68323, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="9fbf91d3-2a4f-4a67-9cb0-66229863719f"
class Actor:
...
```python colab={"base_uri": "https://localhost:8080/"} id="bW0aBsS5tuZs" executionInfo={"status": "ok", "timestamp": 1638511437069, "user_tz": -330, "elapsed": 3236, "user": {"displayName": "Sparsh Agarwal", "photoUrl": "https://lh3.googleusercontent.com/a/default-user=s64", "userId": "13037694610922482904"}} outputId="3a9badf2-b4a7-4eec-b730-768df9a085a0"
